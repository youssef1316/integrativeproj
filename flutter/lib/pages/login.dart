              ...
              content: Form(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    ...
                    final ok = RegExp(r"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9]+\.[a-zA-Z]+$")
                        .hasMatch(value.trim());
                    if (!ok) return 'Please enter a valid email format';
                    return null;
                  },
  ...
  Future<void> _loginUser() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        //Check if user email is verified and resends verification link if not true
        await user.reload();
        ...
        if (user != null && !user.emailVerified) {
          ...
          _showSnackBar("Please verify your email before logging in. We've re-sent the link.", isError: true);
        ...
        if (userDoc.exists && userDoc.data() != null) {
          ...
          print("User document not found for UID. Defaulting to user role.");
          if (!mounted) return;
          Navigator.pushReplacementNamed(context, AppRoutes.userHome);
        }
